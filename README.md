...
- Instead of trucks, you could think of fitbit devices sending GPS coordinates to a Kafka server, and have a consumer application to use GPS coordinates to calculate a person's velocity and write this velocity to a new Kafka topic that can queried by a data analyst or used in another consumer application
